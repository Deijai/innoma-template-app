    ...
    <Screen>
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 40, gap: 14 }} showsVerticalScrollIndicator={false}>
        <Card style={{ gap: 12 }}>
          ...
          <TextField label="UF" value={vm.form.estado} onChangeText={(v) => vm.setField('estado', v)} errorText={vm.errors.estado} maxLength={2} autoCapitalize="characters" />
          <TextField
            label="Responsável"
          ...
          />
          <TextField label="Telefone" value={vm.form.telefone} onChangeText={(v) => vm.setField('telefone', v)} errorText={vm.errors.telefone} keyboardType="phone-pad" />
          ...
          <SelectField
            ...
            valor={vm.form.tipoProducao}
            onChange={(v) => vm.setField('tipoProducao', v)}
            opcoes={farmTypeOptions}
          />
